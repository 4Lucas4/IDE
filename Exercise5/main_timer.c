...
void initPDB(void){
	...
	PDB0_MOD = PDB_MOD_MOD(DEFAULT_SYSTEM_CLOCK/(20*128*2)); // modulus division by 2 TODO NOT SURE IF THIS IS RIGHT
	...
	PDB0_SC &= ~PDB_SC_PDBEN_MASK; // Disable PDB0 Timer bit 7 
